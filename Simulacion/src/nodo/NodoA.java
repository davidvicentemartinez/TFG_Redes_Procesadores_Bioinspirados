...
public class NodoA extends Nodo{
	...
	public NodoA(List<Nodo> listaAdyacentes, Polarizacion polarización, int numNodo) {
		super(listaAdyacentes, polarización, numNodo);
		// TODO Auto-generated constructor stub
	}

	public NodoA(List<Nodo> listaAdyacentes, Polarizacion polarización) {
